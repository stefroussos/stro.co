...
const blocks: ProjectModel = {
  ...
  body: [
    ...
    },
    {
      ...
      description:
        "The Blockstore is hardware & software marketplace for people to purchase modules & apps for their watch.",
