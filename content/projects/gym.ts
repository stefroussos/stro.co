...
const gym: ProjectModel = {
  ...
  body: [
    ...
    },
    {
      ...
      description: "The name ‘Quartz’ is derived from the central role that quartz crystals play in mechanical time keeping. This alludes to the service’s core function - keeping track of time (within the relative ‘gym' context).",
      media: ["brand.jpg"]
    },
    {
    ...
    },
    {
      ...
      description: "Developing the service's UI design language, & user experience. Part of the UX, the loyalty program, is designed to extend the quartz crystal metaphor, in which user membership tiers are presented as different crystals (as opposed to the hackneyed silver, gold, etc system).",
      media: ["tiers.jpg", "app_ui.jpg"]
    },
    {
      title: "Design Development - Locker / Tracker",
      description: "Iterating on the ergonomics, accessibility and affordances of the product. Certain aspects of the product were designed to be purely mechanical (as opposed to electronic), like rotating the outer bezel to engage the lock and the ‘press to eject’ mechanism for the tracker, creating familiar tangible interaction.",
